        ...
        const classes = "information " + (this.props.colorScreen===null?null:(this.props.colorScreen)? "informationRed":"informationGreen");
            return (
                <div className={classes}>
                    <p>
                    {this.props.textOnScreen}
                    </p>
                </div>
            );
    };
    arrow() {
        if (this.props.whoShoot!==null&&this.props.userCounter!==0&&this.props.AICounter!==0){
            const classes = "arrow "+(this.props.whoShoot? "arrow180":null);
            return (
                <img
                    className={classes}
                    src={arrow}
            ...
            let userHealth = Object.assign({}, this.state.userHealth);
                ...
                if(this.state.angryMode1 === false && userHealth.fourDesk !==0){
                    ...
                    this.setState({
                        ...
                        textOnScreen: "В ваш корабль попали!",
                        colorScreen: true,
                    });
                }
                    ...
                    this.setState({
                        ...
                        angryMode2: false,
                        angryMode3: false,
                        textOnScreen: "Ваш четырёхпалубный корабль потопили!",
                        colorScreen: true,
                    });
                    this.doYouFail();
                }
            ...
            if (this.state.fieldUser[shoot].shipIsHere === 2) {
                ...
                if (this.state.fieldUser[shoot].numberOfShip === 1){
                    ...
                    if(this.state.angryMode1 === false && userHealth.twoDeskOne !==0){
                        ...
                        this.setState({
                            angryMode1: false,
                            textOnScreen: "Ваш двухпалубный корабль потопили!",
                            colorScreen: true,
                        });
                        this.doYouFail();
                    }
                ...
                needToShooting = true;
                this.setState({
                    textOnScreen: "Ваш однопалубный корабль потопили!",
                    colorScreen: true,
                });
                this.doYouFail();
            }
            ...
            if (this.state.fieldAI[i].shipIsHere === 0) {
                ...
                if (this.state.fieldAI[i].numberOfShip === 1){
                    if (this.state.AIHealth.twoDeskOne===2){
                        ...
                        this.setState({
                            textOnScreen:"Вы потопили двухпалубный",
                            colorScreen: false,
                        });
                ...
                if (this.state.fieldAI[i].numberOfShip === 1){
                    if (this.state.AIHealth.threeDeskOne===3){
                        ...
                        this.setState({
                            textOnScreen: "Вы потопили трёхпалубный!",
                            colorScreen: false,
                        });
                        this.doYouWin(intObject,intObjectCoordinates);
                    }
                ...
                if (this.state.fieldAI[i].numberOfShip === 2){
                    ...
                    if (this.state.AIHealth.fourDesk===4){
                        ...
                        this.setState({
                            textOnScreen: "Вы потопили четырёхпалубный!",
                            colorScreen: false,
                        });
                        this.doYouWin(intObject,intObjectCoordinates);
                    }
            ...
            <div className="containerStart">
                ...
                <div className={"container"}
                    ...
                    <CenterField
                        ...
                        textOnScreen = {this.state.textOnScreen}
